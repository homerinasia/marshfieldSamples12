...
if exists (select * from sys.sysdatabases where name='pubs')
begin
...
insert titles values('PS1372', 'Computer Phobic AND Non-Phobic Individuals: Behavior nvariations',
'psychology', '0877', $21.59, $7000.00, 10, 375,
'10/21/91')

insert titles (title_id, title, type, pub_id ) values('PC9999', 'Net Etiquette',
'popular_comp', '1389' )
